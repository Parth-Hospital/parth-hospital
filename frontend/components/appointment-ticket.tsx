...
export function AppointmentTicket({
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const address = "Polytechnic chauraha, Gurugram, Haryana 122001";
      ...
      const addDetailRow = (label: string, value: string, icon?: string) => {
        // Background box
      ...
      yPos += 6;
      pdf.text(
        "For queries, call: +91 99406 15757 | Email: parthhospitalgurugram@gmail.com",
        pageWidth / 2,
        yPos,
        { align: "center", maxWidth: contentWidth },
      );
  ...
  return (
    <div className="bg-white rounded-lg border-2 border-primary p-8 max-w-2xl mx-auto">
      ...
      <div className="text-center border-b-2 border-primary pb-4 mb-6">
        ...
        <h1 className="text-3xl font-bold text-primary mb-2">Parth Hospital</h1>
        <p className="text-sm text-gray-600 mb-2">
          Appointment Confirmation Ticket
        </p>
        <p className="text-xs text-gray-500">
          Polytechnic chauraha, Gurugram, Haryana 122001
        </p>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg border-l-4 border-primary">
          ...
          <div className="flex-1">
            <div className="text-xs uppercase tracking-wider text-gray-600 font-semibold mb-1">
              Patient Name
            </div>
      ...
      <div className="mt-6 pt-4 border-t border-gray-200 text-center text-xs text-gray-600 space-y-1">
        <p>
          Please bring this ticket to the reception counter on your appointment
          date.
        </p>
        <p>
          For queries, call: +91 99406 15757 | Email:

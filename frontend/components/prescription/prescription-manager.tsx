...
export function PrescriptionManager() {
  ...
  const handlePrint = useCallback(() => {
    ...
    // Small delay to ensure transform reset applies
    setTimeout(() => {
      ...
      printStyle.textContent = `
        @media print {
          ...
          /* The outer wrapper from prescription-manager */
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-2 text-center sm:hidden">
            💡 Scroll horizontally to view full prescription. Print will be full
            size.
          </p>
        </CardContent>
      </Card>

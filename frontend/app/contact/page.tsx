  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await inquiryApi.createInquiry({
        ...
        email: formData.email || "noreply@parthhospital.co.in",
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg sm:text-xl md:text-2xl font-light text-muted-foreground leading-relaxed max-w-3xl break-words">
              Whether it's an emergency, a consultation, or a simple inquiry,
              ...
              return (
                ...
                >
                  ...
                  <div>
                    ...
                    <p
                      className={`text-sm ${item.textColor} opacity-60 mb-4 font-medium uppercase tracking-wider`}
                    >
                      {item.type}
                    </p>
                    <p className={`text-xl font-bold ${item.accentColor}`}>
                      {item.value}
                    </p>
                  </div>
                </motion.a>
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Located in the heart of Gurugram, making it easily accessible
                  for patients across the district.
                </p>
              </div>
                ...
                {[
                  {
                    icon: MapPin,
                    title: "Main Address",
                    content: "Polytechnic chauraha, Gurugram, Haryana 122001",
                  },
                  {
                    icon: Mail,
                    title: "Email Support",
                    content: "parthhospitalgurugram@gmail.com",
                  },
                ].map((item, i) => {
                  const Icon = item.icon;
                  return (

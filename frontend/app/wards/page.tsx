  ...
  const wards = [
    {
      name: "General Ward",
      description:
        "Comfortable shared accommodation with essential amenities for patients requiring standard care.",
    ...
    },
    {
      ...
      description:
        "Shared room with 2-3 beds, offering more privacy and comfort than general wards.",
    ...
    },
    {
      name: "Private Ward",
      description:
        "Single occupancy rooms with premium amenities for patients seeking privacy and comfort.",
      capacity: "Single bed",
      features: [
        "Complete Privacy",
        "Premium Amenities",
    ...
    },
    {
      name: "ICU/CCU",
      description:
        "Intensive Care Units equipped with advanced monitoring systems for critical patients.",
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comfortable and well-equipped patient accommodation designed for
              your comfort and recovery. We offer various ward options to suit
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              All our wards are equipped with modern amenities to ensure your
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Ward allocation is based on availability and medical requirements.
              Our staff will assist you in choosing the most suitable
              accommodation option during your admission process.
            </p>
            <p className="text-muted-foreground">
              For more information about ward availability and booking, please

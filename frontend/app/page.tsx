              ...
              <div className="flex items-center gap-6 flex-1">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-blue-100 text-base md:text-lg leading-relaxed">
                    Parth Hospital proudly accepts Ayushman Bharat Pradhan
                    Mantri Jan Arogya Yojana (AB-PMJAY) cards. Get quality
                    healthcare services covered under the government health
                    insurance scheme.
                  </p>
                </div>
              </div>
          ...
          <div className="mb-16 text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Trusted orthopedic care with modern facilities and experienced
          ...
          <div className="space-y-24 md:space-y-32">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  State-of-the-art surgical theaters and diagnostic equipment
                  ensuring the highest standards of medical care and precision
                  in every procedure.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="space-y-4 md:order-1 order-2">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Dr. Ashish Bharadwaj and experienced orthopedic specialists
                  dedicated to providing compassionate, personalized care with
                  years of expertise.
                </p>
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed">
                  Emergency services and round-the-clock patient care ensuring
                  you receive immediate medical attention whenever you need it.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center space-y-8 relative z-10">
          <div>
            ...
            <p className="text-lg text-white/90 max-w-2xl mx-auto">
              Get expert orthopedic care from Dr. Ashish Bharadwaj. Call or book

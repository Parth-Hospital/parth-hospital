      ...
      items: [
        {
          icon: Utensils,
          name: "Cafeteria",
          description: "Fresh and nutritious meals available",
        },
        {
          icon: Coffee,
          name: "Tea & Snacks",
          description: "Refreshments available throughout the day",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          icon: Phone,
          name: "Phone Services",
          description: "Public phone facilities available",
        },
      ],
    },
    {
      ...
      items: [
        {
          icon: ShoppingBag,
          name: "Medical Store",
          description: "In-house pharmacy for medicines and supplies",
        },
        {
          icon: FileText,
          name: "Documentation Help",
          description: "Assistance with medical reports and documents",
        },
      ],
    },
    {
      ...
      items: [
        {
          ...
          description: "Patient counseling and support services",
        },
        {
          icon: Users,
          name: "Visitor Facilities",
          description: "Comfortable waiting areas for visitors",
        },
        {
          icon: Shield,
          name: "Security",
          description: "24/7 security services for patient safety",
        },
      ],
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We provide a wide range of amenities and facilities to ensure your
              comfort and convenience during your visit to Parth Hospital.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              At Parth Hospital, we continuously strive to enhance our
              facilities and services to provide you with the best possible
              experience. Our amenities are designed to make your stay as
              comfortable and convenient as possible.
            </p>
            <p className="text-muted-foreground">
              For any specific requirements or assistance, please contact our
              reception at{" "}
              <a
